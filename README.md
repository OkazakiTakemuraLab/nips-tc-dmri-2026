...
2026年8月3日-8月7日に生理学研究所で開催する **『第37回生理科学実験技術トレーニングコース・拡散強調MRIデータ解析による白質線維束分析入門』** の参加者を対象とした情報提供サイトです。随時、情報を変更・追加していきますので、受講内定者の方はこのサイトへ定期的にアクセスするようにして下さい。

## 新着情報

- 2026.6.25 トレーニングコース用ウェブサイトを立ち上げました
- ⚠️ Notice準備中：READMEおよび関連ドキュメントは今後も継続的に更新される予定です。一部の説明は変更される可能性があります。
...
- チューター：生理学研究所 感覚認知情報研究部門 若手研究者雇用特別研究員 仲田穂子
- チューター：総合研究大学院大学 生理科学コース 博士課程大学院生  田熊大輝
- チューター：総合研究大学院大学 生理科学コース 博士課程大学院生  中村阿佑香
- チューター：総合研究大学院大学 生理科学コース 博士課程大学院生  Qiang Yueying
...
18:00-20:00 | トレーニングコース全体交流会（岡崎コンファレンスセンター（OCC））
8月6日 |
...
15:00-15:10 | 休憩
15:10-15:40 | 研究発表：田熊大輝（トラクトメトリーに関する方法論的研究）
15:40-16:00 | 休憩
16:00-17:00 | 外部講演：井上　謙一先生（名古屋市立大学)
17:30-19:30 | 拡散強調MRIコース交流会（予定, 詳細は後日連絡）
8月7日 |
9:00-9:30 | デモ：pyAFQ (竹村)
9:30-9:40 | 休憩
9:40-10:20 | 講義（１１）Diffusion MRI：できること・できないこと＋より高度なアプローチの紹介 (竹村・大石)
10:20 | グループワーク説明 (竹村)
10:20-12:00 | グループワーク
12:00-13:00 | -- 昼休み --
...
- **トレーニングコースの準備に、約4-5時間必要となります。準備なしの参加はできません。**

- 受講者専用サイトに記載されているDocker+Lin4Neuroの組み合わせによる参加を前提とします。脳画像解析の初心者の方々は受講者専用サイトに記載されている通りに事前準備を行いトレーニングコースへ参加することを強く推奨します。
...
- ソフトウェアとデータのダウンロードで合計**20GB程度ダウンロードします**。Pocket Wi-Fiなどでは契約の上限に達してしまう可能性もありますので、**職場やご自宅のLAN環境からの作業**を強くお奨めします。
　

### 1. トレーニングコース用Lin4Neuroのセットアップ

- **以下のページを参考にセットアップをして下さい。**
  - [生理研トレーニングコース用Lin4Neuroのセットアップ (Windows)](https://github.com/kytk/nips-web-2026/wiki/02_1_Windows_Docker)
  - [生理研トレーニングコース用Lin4Neuroのセットアップ (Mac)](https://github.com/kytk/nips-web-2026/wiki/02_2_macOS_Docker)

- Lin4Neuroがセットアップできましたら、ターミナルウィンドウ上で 

mrview 

と打ち込み、MRTrix3の画面が立ち上がるかについて確認をお願いします。
